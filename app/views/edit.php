    ...
    <div>
        ...
        <form action="" method="POST">
            <div class="mb-2">
                ...
                <input type="text" name="bookName" value="<?php echo $chosenBook->getBookName(); ?>" class="form-control" />
            </div>
            <div class="mb-2">
            ...
            <div class="mb2">
                ...
                <input type="text" name="bookDesc" class="form-control" value="<?php echo $chosenBook->getBookDesc(); ?>">
            </div>
            <button class="btn btn-primary" type="submit" name="edit">Lưu</button></td>
        </form>
    </div>
</body>
